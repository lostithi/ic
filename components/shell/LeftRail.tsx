    ...
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-[72px] border-r border-black/70 md:block">
      <div className="flex h-full flex-col">
        <div className="flex h-20 items-center justify-center border-b border-black/70">
          <span className="font-mono-ui text-[11px] uppercase tracking-[0.18em] text-black">
        ...
        <div className="border-t border-black/70 px-2 py-4 text-center font-mono-ui text-[10px] uppercase tracking-[0.16em] text-black">
          2026//
        </div>
      </div>
    </aside>
